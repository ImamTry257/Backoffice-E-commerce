	...
	<form method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-12 input">
				<input type="text" class="col-md-8 col-md-push-2" placeholder="Nama Lengkap" name="nama" required="">
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 input">
				...
				?>
				<input type="text" class="col-md-8 col-md-push-2" placeholder="Username" name="username" required="">
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 input">
				...
				?>
				<input type="file" class="col-md-8 col-md-push-2" placeholder="Foto anda" name="foto">
			</div>
		</div>
...
<?php }elseif(isset($_POST["signUp"])){
	...
	?>
		...
		<form method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-12 input">
					<input type="text" class="col-md-8 col-md-push-2" placeholder="Nama Lengkap" name="nama" value="<?php echo $_SESSION["daftar_admin"]["nama"]; ?>">
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 input">
			...
			<div class="row">
				<div class="col-md-12 input">
					<input type="password" class="col-md-8 col-md-push-2" placeholder="Password" name="password" value="<?php echo $_SESSION["daftar_admin"]["password"]; ?>">
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 input">
