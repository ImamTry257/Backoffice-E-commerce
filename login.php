...
?>
				...
				<div class="row">
					<div class="col-md-12 tombol">
						<!-- <a href="intro.php?halaman=signUp" class="col-md-4 col-md-push-2 tombol_signUp">Sign Up</a> -->
				...
				<form action="" method="post">
					<div class="row">
						<div class="col-md-12 input">
							<input type="text" class="col-md-8 col-md-push-2" placeholder="Nama" name="nama" autofocus="" required=""></input>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 input">
					...
					<div class="row">
						<div class="col-md-12 input">
							...
							?>
							<input type="password" class="col-md-8 col-md-push-2" placeholder="Konfrim Password" name="confrim_password" required=""></input>
						</div>
					</div>
					<div class="row">
